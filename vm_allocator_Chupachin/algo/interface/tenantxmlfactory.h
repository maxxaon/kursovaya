...
public:
    ...
    void readAssignmentNodesData(const class ResourcesXMLFactory& resourceFactory);
    void readAssignmentLinksData(const class ResourcesXMLFactory& resourceFactory);
